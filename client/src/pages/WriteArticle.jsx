  ...
  return (
    ...
    gap-4 text-slate-700'>
     ...
     border-gray-200'>
      ...
      <input onChange={(e) => setInput(e.target.value)} className='w-full p-2 px-3 mt-2 outline-none text-sm
      rounded-md border border-gray-300' placeholder='The future of artificial intelligence is...' required value={input} type="text"/>
