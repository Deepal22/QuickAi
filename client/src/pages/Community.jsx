...
const Community = () => {
  ...
  return !loading ? (
    <div className='flex-1 h-full flex flex-col text-bold gap-4 p-6'>
      Creations
          ...
          sm:max-w-1/2 lg:max-w-1/3'>
            ...
            rounded-lg'>
              ...
              <div className='flex gap-1 items-center'>
                ...
                <Heart onClick={() => imageLikeToggle(creation.id)} className={`min-w-h h-5 hover:scale-110 cursor-pointer
    ...
    <div className='flex justify-center items-center h-full'>
      <span className='w-4 h-4 my-1 rounded-full border-3
